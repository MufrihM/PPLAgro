...
if(isset($_POST['submit'])){
    ...
    if(in_array($fileExtension, $extension)){
        ...
        $sql="insert into produk (Nama, Harga, Foto) 
        values('$name', '$harga', '$uploadImage')";
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <button type="button" class="mb-2 mx-2 col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 btn text-light" style="background-color: #448D09;"><ion-icon name="add-outline"></ion-icon> Tambahkan produk</button>
            <button type="button" class="mb-2 mx-2 col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 btn text-light" style="background-color: #E39908;"><ion-icon name="pencil-outline"></ion-icon> Ubah produk</button>
            <button type="button" class="mb-2 mx-2 col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 btn text-light" style="background-color: #DD2902;"><ion-icon name="trash-outline"></ion-icon> Hapus produk</button>
        </div>
    </div>
